...
<br>
                      ...
                      <tbody style="background-color: #e6ccb3"><tr>
                <td class="TrackTitle" valign="top"><div class="newtext" align="center" style="font-size: 20px" class="w3-panel w3-border w3-round"><strong><i>Track your Packet</i><br>
                        </strong></div></td>
              </tr>
              ...
              <div align="center">
                   <div class="w3-card" align="center" style="width:50%; background-color: #ffdb4d;border: 2px solid black">
              <tr bgcolor="EFEFEF">
            ...
            <form action="track-result.php" method="post" name="form" id="form" >
			      ...
			      <span class="gentxt"><br></span> </div></td>
                </tr>
                </div>
              <tr bgcolor="EFEFEF">
                <td valign="top">&nbsp;</td>
